...
def setchat_title(update: Update, context: CallbackContext):
    ...
    title = " ".join(args)
    if not title:
        msg.reply_text("provide some text to add title in group 😒")
        return
...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    if user_member.status in ('administrator', 'creator'):
        message.reply_text("They are already admin sed lyf")
        return

    if user_id == bot.id:
        message.reply_text("I can't promote my self understand noob")
        return
    ...
    try:
        ...
        if err.message == "User_not_mutual_contact":
            message.reply_text("I can't promote anyone")
        else:
            message.reply_text("occured error in promoting.😏💫")
        return
...
def lowpromote(update: Update, context: CallbackContext) -> str:
    ...
    if (
        ...
        message.reply_text("You don't have right to see this")
        return
    ...
    if user_member.status in ('administrator', 'creator'):
        message.reply_text("He is already admin I can't promote again and again")
        return
...
def fullpromote(update: Update, context: CallbackContext) -> str:
    ...
    if user_member.status in ('administrator', 'creator'):
        message.reply_text("He is already admin I can't admin again and again")
        return
...
def demote(update: Update, context: CallbackContext) -> str:
    ...
    if user_id == bot.id:
        message.reply_text("You can't demote me")
        return
